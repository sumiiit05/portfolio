...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_5737smj', 'template_clnnlnn', formRef.current, 'F1jjkkBoLrLqZdXOs')  // Pass public key string here
      .then(
        (result) => {
          setSuccess(true);
          setError(false);
    ...
    >
      ...
      <div className="formContainer">
        ...
        >
          ...
          {error && <span style={{ color: "red" }}>Error: Failed to send email.</span>}
          {success && <span style={{ color: "green" }}>Success: Email sent!</span>}
        </motion.form>
      </div>
    </motion.div>
  );
